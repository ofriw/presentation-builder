...
export const deck: Slide[] = [
  ...
  // ── Slide 5 — v1: The Obvious Approach (and Why It Fails) ──
  {
    ...
    icon: "failure",
    content: {
      steps: ["Code", "Chunks", "Embeddings", "Vector DB", "Top‑K", "LLM"],
      failureAt: 4,
      scaleMismatch:
        "One real feature can span hundreds of files and thousands of chunks.",
  ...
  // ── Slide 6 — Deep Research for Code ─────────────────────────
  {
    ...
    content: {
      ...
      ledger: ["architecture", "constants", "patterns", "constraints"],
      ...
      spokes: [
        {
          ...
          caption: "control flow · calibration logic",
          icon: "code",
        },
        {
          title: "Test coverage",
          caption: "assertions · edge cases · safety checks",
          icon: "evidence",
        },
        {
          title: "Architecture",
          caption: "modules · dependencies · state machines",
          icon: "architecture",
        },
      ],
  ...
  // ── Slide 9 — One Year In ──────────────────────────────────
  {
    ...
    content: {
      ...
      proof: [
        { label: "Kimara AI", icon: "kimara-ai", hideLabel: true },
        { label: "Riot Games", icon: "riot-games" },
        { label: "US Gov contractors", icon: "us-gov" },
        "and growing…",
      ],
    },
    notes:
